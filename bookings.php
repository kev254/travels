          ...
          <div class="container p-0">
            <div class="row">
              ...
              <div class="col-lg-3 order-2 order-lg-1">
                ...
                <div class="py-2 px-4 bg-dark text-white mb-3"><strong class="small text-uppercase font-weight-bold">Cabs</strong></div>
                <ul class="list-unstyled small text-muted pl-lg-4 font-weight-normal">
                  <li class="mb-2"><a class="reset-anchor" href="add-room.php">Add</a></li>
                  <li class="mb-2"><a class="reset-anchor" href="rooms.php">Manage</a></li>
                  
                </ul>
                <div class="py-2 px-4 bg-light mb-3"><strong class="small text-uppercase font-weight-bold">Hotels &amp; Restaurants</strong></div>
                <ul class="list-unstyled small text-muted pl-lg-4 font-weight-normal">
                  <li class="mb-2"><a class="reset-anchor" href="add-cars.php">Add</a></li>
                ...
                <table class="table">
                  <thead class="bg-light">
                    ...
                    <tr>
                      ...
                      <th class="border-0" scope="col"> <strong class="text-small text-uppercase">Dates</strong></th>
                      <th class="border-0" scope="col"> <strong class="text-small text-uppercase">Adults</strong></th>
                      <th class="border-0" scope="col"> <strong class="text-small text-uppercase">Rooms</strong></th>
                      <th class="border-0" scope="col"> <strong class="text-small text-uppercase">Messages</strong></th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td class="align-middle border-0">
                       ...
                       <td class="align-middle border-0">
                        <p class="mb-0 small"><?php echo $row['email']; ?></p>
                      </td>
                       <td class="align-middle border-0">
                        <p class="mb-0 small"><?php echo $row['phone']; ?></p>
                      </td>
                      
                      <td class="align-middle border-0">
                        <p class="mb-0 small"><?php echo $row['day']."-".$row['month']."-".$row['year']; ?></p>
                      </td>
                       <td class="align-middle border-0">
                         <p class="mb-0 small"><?php echo $row['adults']; ?></p>
              
                      </td>
                      <td class="align-middle border-0">
                         <p class="mb-0 small"><?php echo $row['rooms']; ?></p>
              
                      </td>
                      <td class="align-middle border-0">
                        <p class="mb-0 small"><?php echo $row['message']; ?></p>
                      </td>
                      <td class="align-middle border-0">
                      <a class="reset-anchor" href="all-rooms.php?del=<?php echo $row['id']; ?>"><i class="fa fa-pencil"></i><button class="btn btn-outline-danger" style="border-radius: 5px;">Delete</button></a></td>
                    </tr>
                    <?php
                                            }
                                        }
