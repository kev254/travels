...
<?php require_once('header-admin.php');?>
        ...
        <div class="container-fluid body-section container">
            <div class="row">
                <div class="col-md-12">
                    <h2><i class="fa fa-plus-square"></i> parks <small>Add New park</small></h2>
                    ...
                    if(isset($_POST['submit'])){
                        ...
                        $q = "SELECT * FROM trips ORDER BY trips.id DESC LIMIT 1";
                        ...
                        if(empty($title) or empty($post_data) or empty($size) or empty($price) or empty($image1) or empty($image2) or empty($image3) or empty($image4)){
                            ...
                            $insert_query = "INSERT INTO trips (`id`,`title`,`description`,`size`,`price`,`image1`,`image2`,`image3`,`image4`) VALUES ($id,'$title','$post_data','$size','$price','$image1','$image2','$image3','$image4')";
                        ...
                        <div class="col-xs-12">
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    ?>
                                    <input type="text" name="title" placeholder="Type park Title Here" value="<?php if(isset($title)){echo $title;}?>" class="form-control">
                                </div>
                                ...
                                <input type="submit" class="btn btn-primary" value="Add park" name="submit">
                            </form>
                        </div>
                    </div>
                </div>
