                ...
                <table class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle border-0"><a class="reset-anchor" href="edit-room.php?id=<?php echo $row['id']; ?>"><button class="btn btn-outline-info" style="border-radius: 5px;">Edit</button></a>
