...
<?php require_once('header-admin.php');?>
        ...
        <div class="container-fluid body-section container">
            <div class="row">
                <div class="col-md-12">
                    <h2><i class="fa fa-plus-square"></i> Cabs <small>Add New Cab</small></h2>
                    ...
                    if(isset($_POST['submit'])){
                        ...
                        $q = "SELECT * FROM cabs ORDER BY cabs.id DESC LIMIT 1";
                        ...
                        if(empty($title) or empty($post_data) or empty($size) or empty($price) or empty($image1) or empty($image2) or empty($image3) or empty($image4)){
                            ...
                            $insert_query = "INSERT INTO cabs (`id`,`title`,`description`,`size`,`price`,`image1`,`image2`,`image3`,`image4`) VALUES ($id,'$title','$post_data','$size','$price','$image1','$image2','$image3','$image4')";
                        ...
                        <div class="col-xs-12">
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    ?>
                                    <input type="text" name="title" placeholder="Type cab Title Here" value="<?php if(isset($title)){echo $title;}?>" class="form-control">
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="size">Seat</label>
                                            <input type="text" name="size" placeholder="seat" value="<?php if(isset($title)){echo $size;}?>" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                ...
                                <input type="submit" class="btn btn-primary" value="Add cab" name="submit">
                            </form>
                        </div>
                    </div>
                </div>
